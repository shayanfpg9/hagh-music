  ...
  return (
    <>
      <header className="absolute w-11/12 h-1/6 bg-rose-100 left-1/2 -translate-x-1/2 mt-2 rounded-full flex justify-center items-center">
        ...
        <a
          title="لوگو"
          className="absolute right-2 top-1/2 -translate-y-1/2 w-20 sm:w-28 lg:w-32 2xl:w-48"
          href="/"
        >
          <img
        ...
        <span
          ...
          className="w-14 sm:w-20 lg:w-24 2xl:w-32 cursor-pointer absolute left-4"
        >
