...
export default function Landing() {
  return (
    <section className="h-full flex justify-center items-center">
      <p className="basis-3/4 text-xl text-rose-700 font-medium flex justify-center items-center flex-wrap">
        ...
        <section className="flex justify-center items-center flex-col mt-4 text-rose-800">
          <Link className="bg-rose-200 p-4 mt-2 rounded-2xl hover:shadow-lg hover:shadow-rose-300 hover:-translate-y-2" to="/team">اشنایی با تیم</Link>
          <Link className="bg-rose-200 p-4 mt-4 rounded-2xl hover:shadow-lg hover:shadow-rose-300 hover:-translate-y-2" to="/musics">بازدید از آهنگ ها</Link>
        </section>
      </p>
